...
venue: "SURGE - Learn Git Version Control"        # brief name of host site without address (e.g., "Euphoric State University")
...
humandate: "September 18, 2019"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "12:30 pm - 1:30 pm"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
startdate: 2019-18-11      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2019-18-11        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
...
helper: ["Caitlin Bate", "Ryan Gosse", "Naomi Tress", "Angela Dini"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["bruce.delo@dal.ca", "Caitlin.Bate@dal.ca", "Ryan.Gosse@dal.ca", "ntress@dal.ca", "an967853@dal.ca"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
