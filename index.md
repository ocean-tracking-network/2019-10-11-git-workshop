...
venue: "SURGE - Discover Coding Python Workshop"        # brief name of host site without address (e.g., "Euphoric State University")
...
instructor: ["Alex Nunes", "Danielle Quinn"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Jon Pye", "Angela Dini"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["anunes@dal.ca, jonathan.pye@dal.ca", "Angela.Dini@dal.ca"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
